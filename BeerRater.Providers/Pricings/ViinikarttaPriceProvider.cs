...
namespace BeerRater.Providers.Pricings
{
    ...
    internal sealed class ViinikarttaPriceProvider : PriceProviderBase
    {
        ...
        ///     Gets the name.
        /// </summary>
        public override string Name => "Viinikartta Price Provider";
        ...
        {
            var url =
                $"http://www.viinikartta.fi/db/search_by_name_fragment.php?term={beerName.Trim().UrlParamEncode()}&searchtype=";
            ...
            if (response != null && response.StatusCode == HttpStatusCode.OK)
            {
                ...
                if (data != null && data.results != null && data.results.Length > 0)
                {
                    ...
                    if (priceNode != null)
                        return new ReferencePrice(priceNode.InnerText.TrimDecoded().ToDouble() ?? default(double), priceUrl);
                }
            }
